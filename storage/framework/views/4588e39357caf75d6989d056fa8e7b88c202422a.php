...
<div class="row">
    ...
    <center><h2>FORMULARIO FICHA DE INCIDENTES</h2></center>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" name="form" action="<?php echo e(url('Gestiones/Guardar')); ?>" role="form" method="POST" enctype="multipart/form-data">

                    <div class="box-body">

                        <P>Registrar o agendar gestiones.</P>  <br>

                        <input type="hidden" name="id_accidente" value="<?php echo $inc->id_incidentes?>">
