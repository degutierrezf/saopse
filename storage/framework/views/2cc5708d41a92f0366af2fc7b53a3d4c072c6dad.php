...
<div class="col-md-10">
              ...
              <div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" name="form" action="<?php echo e(url('Accidente/Guardar')); ?>" role="form" method="POST">
                  ...
                  <div class="box-body">
	                  ...
	                  <label for="exampleInputEmail1" class="col-sm-3 control-label">Seleccione la Ruta:</label>
	                  	...
	                  	<select class="form-control pull-right">
		                    <option class="form-control pull-right">Conc. Valles del Biobío RUTA Q-97-N</option>
		                    <option class="form-control pull-right">Conc. Valles del Desierto RUTA H-55-OP</option>
	                  	</select>
	                  	</div>
	                </div>    
		            ...
		            <div class="form-group" >
			               	<label for="exampleInputEmail1" class="col-sm-3 control-label">Ruta:</label>
			                    <div class="col-sm-8">
			                    	 <input type="radio" name="r10" class="minimal" checked> Troncal <br>
			                    	 <input type="radio" name="r10" class="minimal"> Ramal <br>
			                   	</div>
		            </div>
		            ...
		            <div class="form-group" >
			               	<label for="exampleInputEmail1" class="col-sm-3 control-label">By Pass:</label>
			                    <div class="col-sm-8">
			                    	 <input type="radio" name="r1" class="minimal" checked> Si <br>
			                    	 <input type="radio" name="r1" class="minimal"> No <br>
